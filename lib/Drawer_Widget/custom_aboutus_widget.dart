...
class CustomAboutUsWidget extends StatefulWidget {
  const CustomAboutUsWidget({super.key});

  @override
  State<CustomAboutUsWidget> createState() => _CustomAboutUsWidgetState();
}

class _CustomAboutUsWidgetState extends State<CustomAboutUsWidget> {
        ...
        children: [
          ...
          Padding(
            ...
            child: CustomHaderWidget(
                      showSerchBar: false, showaddBtn: true,onPressed: (){aboutusAlert(context: context);},
                      titel: "About Us",
                    ),
          ),
          Expanded(
            child: SingleChildScrollView(
              ...
              child: customText(
                  adminHomeController.getAbouteUsDetails.value.data!.aboutus != null
                      ? adminHomeController.getAbouteUsDetails.value.data!.aboutus.toString()
                      : aboutus,
